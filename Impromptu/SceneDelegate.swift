...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // setCurrentWindow(controller: VotingController(question: MockData.question))
        // setCurrentWindow(controller: RoundResultsController(nibName: nil, bundle: nil))
        
        let vc = UINavigationController(rootViewController: LandingController())
            
        setCurrentWindow(controller: vc)
